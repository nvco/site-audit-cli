...
function buildMarkdown(result: AuditResult, issues: Issue[], title: string): string {
  ...
  lines.push(`# ${title}\n`);
  if (result.config.showToolCredit) lines.push(`*Generated by [site-audit-cli](https://github.com/nvco/site-audit-cli) (github.com/nvco/site-audit-cli)*\n`);
...
<div class="page">
  <h1>${title}</h1>
  ${result.config.showToolCredit ? `<p style="margin:-16px 0 24px;font-size:13px;color:#888">Generated by <a href="https://github.com/nvco/site-audit-cli" style="color:#888;text-decoration:underline" target="_blank" rel="noopener">site-audit-cli</a> (github.com/nvco/site-audit-cli)</p>` : ''}
  <dl class="meta">
